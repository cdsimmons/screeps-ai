// These are just some notes on my trying to figure out the best structure that would work with Screeps
...
// If I move all the helpers into Game object, then it's a bit strange... Game.cacher.store()...
// They aren't classes, so I don't feel comfortable using capitals for them...
// At the moment they are global modules... I would like to require but proving very difficult...
// If I require, then I'd be using require only half-right, because prototype changes would have to be required once before anything else...
// Also, Screeps has so many global variables... to then have half the game required, and half the game global... it seems strange...
// I can't seem to find a good example of people doing it... they just flatten stuff into 1 folder if at all!
// I lose out on unit testing advantages though if I stay this way... and it also makes my code clearer with require...

// Okay I have an idea... I can move all of the Global objects into modules... 
// The module would simply do something like "module.exports = Game", or "module.exports = Creep"... etc
// Then it's clear! I patch away Screeps global variables, and get everything clean in require...

// The problem is how to get require working... I could flatten everything, but that feels like cheating and worried about the added CPU costs...

// Although... Game.map.findExit() is a method... so assigning all to Game might be okay...
// However, it still feels a bit hacky... require is the better way and gives me unit testing advantages... probably?

// After I require in everything, I aim to export a single file...
// When unit testing, I will need to import the src files... which I think is okay... require('../src/bla.js'), etc... 
// Then I can call it's methods standalone...

// Okay, so how to require... advg is using require somehow
// ADVG does some weird shit... it ends up compiling everything into 1 file, and making everything callable in a global AI object...
// Really the result is not that much different to mine, except his is a bit more convoluted...

// I want to keep it simple, but get require working as it normally should...