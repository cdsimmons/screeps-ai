...
module.exports = function(reset) {
    ...
    // Classes... Separate files so that I can stub more easily...
    require('mock/classes/Game');
    require('mock/classes/Map');
    require('mock/classes/RoomPosition');
    require('mock/classes/Room');
    require('mock/classes/Structure');
    require('mock/classes/ConstructionSite');
    require('mock/classes/Creep');
    require('mock/classes/Energy');
    require('mock/classes/Flag');
    require('mock/classes/Source');
    require('mock/classes/Spawn');
    require('mock/classes/StructureTower');

    // Added class extensions here... I wanted to avoid this, but makes sense 
